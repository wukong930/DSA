...
def get_tool_registry():
    ...
    from src.agent.tools.technical import ALL_TECHNICAL_TOOLS
    from src.agent.tools.fundamental import ALL_FUNDAMENTAL_TOOLS

    registry = ToolRegistry()
    for tool_fn in ALL_DATA_TOOLS + ALL_ANALYSIS_TOOLS + ALL_SEARCH_TOOLS + ALL_MARKET_TOOLS + ALL_BACKTEST_TOOLS + ALL_TECHNICAL_TOOLS + ALL_FUNDAMENTAL_TOOLS:
